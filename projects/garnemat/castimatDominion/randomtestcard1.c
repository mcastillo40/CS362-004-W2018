...
int main () {
  ...
  int k[10] = {adventurer, council_room, feast, gardens, mine,
	...
	int discard = 1;
	int failure = 0;
	int i, x, y, loop_counter, loop_counter1, currentPlayer, otherPlayer, testDeck, testHand, controlHand, controlDeck;
	...
	for(loop_counter1 = 0; loop_counter1 < 1000; loop_counter1++)
	{
		...
		//cardEffect(smithy, 0, 0, 0, &test_state, handPos, &bonus);
		smithyEffect(i, currentPlayer, &test_state, handPos);
