...
int main () {
  ...
  int k[10] = {adventurer, council_room, feast, gardens, mine,
	...
	int drawnCards = 2;
	int discard;
	int x, y, loop_counter, loop_counter1, currentPlayer, otherPlayer, testDeck, testHand, controlHand, controlDeck, cardDrawn;
	int failure = 0;
	int temphand[MAX_HAND];
	int z = 0;
	int drawntreasure1, drawntreasure2;
	...
	for(loop_counter1 = 0; loop_counter1 < 2; loop_counter1++)
	{
		...
		state.deck[loop_counter1][4] = gold;
	...
	****************************************************************************************/
	...
	for(loop_counter = 0; loop_counter < 500; loop_counter++)
	{
		...
		cardEffect(adventurer, 0, 0, 0, &test_state, 0, &bonus);
		//adventurerEffect(0, &test_state, currentPlayer, cardDrawn, &temphand, 0);
	...
	****************************************************************************************/
	...
	for(loop_counter1 = 0; loop_counter1 < 2; loop_counter1++)
	{
		...
		state.discard[loop_counter1][3] = gold;
		
		// set discard count to 3
		state.discardCount[loop_counter1] = 4;
